function [RMSE_DC_OBSH, NRMSE_DC_OBSH, CC_DC_OBSH,...
    ...
    = F_FluxMean_UST_MayAug(F_HOD,F_OBSH,F_OBS,C_MEP,C_OBS,WS,RecordsADay,Days)
...
figure(51);
subplot(3,1,1);
plot(1:1:Days, C_MEP_DM,'-or',1:1:Days, C_OBS_DM,'-b');grid on;
legend('MEP','OBS');
ylabel('Daily Mean H (W m^{-2})');
subplot(3,1,2);
plot(1:1:Days,F_HOD_DM,'-or',1:1:Days,F_OBSH_DM,'-*b',1:1:Days,F_OBS_DM,'-k');grid on;
